package com.archko.reader.pdf.scrollbar
 ...
 */
@Composable
public fun ScrollableState.DraggableScrollbar(
 ...
 */
@Composable
public fun ScrollableState.DecorativeScrollbar(
    state: ScrollbarState,
    orientation: Orientation,
    modifier: Modifier = Modifier,
) {
...
private fun scrollbarThumbColor(
    ...
    val color = animateColorAsState(
        targetValue = when (state) {
            ThumbState.Active -> Color.Blue//MaterialTheme.colorScheme.onSurface.copy(0.5f)
            ThumbState.Inactive -> Color.Blue.copy(alpha = 0.2f)//MaterialTheme.colorScheme.onSurface.copy(alpha = 0.2f)
            ThumbState.Dormant -> Color.Gray.copy(alpha = 0.3f)
        },
