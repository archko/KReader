...
public class DjvuDecoder(public val file: File) : ImageDecoder {
    ...
    override fun renderPage(
        ...
        try {
            ...
            if (aPage.cropBounds != null && crop) {
                ...
                val imageBitmap = bitmap?.asImageBitmap() ?: ImageBitmap(
                    outWidth,
                    outHeight,
                    ImageBitmapConfig.Rgb565
                )
    ...
    private fun cropImageBitmap(
        ...
        println("DjvuDecoder.cropImageBitmap:$index, 原始尺寸=${originalBitmap.width}x${originalBitmap.height}, 切边区域=($safeX,$safeY,$safeWidth,$safeHeight), 切边后尺寸=${croppedImageBitmap.width}x${croppedImageBitmap.height}")
